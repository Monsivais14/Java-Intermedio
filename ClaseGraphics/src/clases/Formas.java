...
public class Formas extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() { //Hilo para actializar interfaz
            public void run() {
    ...
    public void paint(Graphics g){
        ...
        g.drawLine(0, 70, 100, 360);  //linea
        g.drawRect(150, 70, 50, 70); //rectangulo
        g.drawRoundRect(250, 70, 50, 70, 6, 6); //rectagulo con bordes circulares
